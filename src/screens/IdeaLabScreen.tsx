...
const styles = StyleSheet.create({
  ...
  revenueCard: { backgroundColor: "rgba(28,55,38,0.70)", borderColor: palette.lineStrong, borderRadius: radius.md, borderWidth: 1, flex: 1, gap: spacing.sm, minWidth: 0, padding: spacing.md },
